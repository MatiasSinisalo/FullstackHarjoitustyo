...
const backEndURI = process.env.NODE_ENV === 'production' ? `https://backend-ohtuprojekti-staging.ext.ocp-test-0.k8s.it.helsinki.fi/` : 'http://localhost:4000';
const backEndWsURL = process.env.NODE_ENV === 'production' ? `wss://backend-ohtuprojekti-staging.ext.ocp-test-0.k8s.it.helsinki.fi/` : 'ws://localhost:4000';
