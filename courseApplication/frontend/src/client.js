...
const backEndURI = process.env.NODE_ENV === "production" ? `http://34.88.224.135:4000/` : 'http://localhost:4000'
const backEndWsURL = process.env.NODE_ENV === "production" ? `ws://34.88.224.135:4000/` : 'ws://localhost:4000'
