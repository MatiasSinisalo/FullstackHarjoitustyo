  ...
  return (
    <div className={`submission:${submission.id} container primary`}>
      ...
      {user.username === submission.fromUser.username ?
                <ContentEditView submitted={submission.submitted} submissionContent={submissionContent} 
                editSubmission={editSubmission} returnSubmission={returnSubmission} onContentChange={updateSubmissionContent}>
                </ContentEditView> :
