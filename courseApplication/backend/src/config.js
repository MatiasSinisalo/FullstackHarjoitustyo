...
const HY_CLIENT_SECRET = process.env.HY_CLIENT_SECRET
const HY_CLIENT_ID = process.env.HY_CLIENT_ID
const HY_CREATE_ACCOUNT_SECRET = process.env.HY_CREATE_ACCOUNT_SECRET

module.exports = {
    SECRET, PORT, MONGODB_URI, IS_TEST, LOCAL_SERVER_URL, 
    GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_CREATE_ACCOUNT_SECRET,
    HY_CLIENT_SECRET, HY_CLIENT_ID, HY_CREATE_ACCOUNT_SECRET
}